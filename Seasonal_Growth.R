...
#terrestrial vertebrates. Ecological Modelling.
...
#(ctf is the original dataframe that includes individuals that were not marked or recaptured)
  ...
  #Removing the few observations with SVL>54 for figure
  #Using Sex40 so that all individuals <40 mm are listed as unknown, even if we later figured out sex
  for(i in 1:11){
